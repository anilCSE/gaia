...
// ExportAppStateAndValidators export the state of aneka for a genesis file
func (app *AnekaApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *AnekaApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
