...
import (
	...
	"github.com/vitwit/aneka/cmd/common"
)
...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		gapp := app.NewAnekaApp(logger, db, traceStore, false, uint(1), map[int64]bool{}, "")
	...
	gapp := app.NewAnekaApp(logger, db, traceStore, true, uint(1), map[int64]bool{}, "")
	return gapp.ExportAppStateAndValidators(forZeroHeight, jailWhiteList)
}
