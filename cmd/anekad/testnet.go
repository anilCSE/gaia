...
func testnetCmd(ctx *server.Context, cdc *codec.Codec,
	...
	cmd := &cobra.Command{
		Use:   "testnet",
		Short: "Initialize files for a Anekad testnet",
...
Example:
	anekad testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "anekad",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "anekacli",
...
func InitTestnet(
	...
	anekaConfig := srvconfig.DefaultConfig()
	anekaConfig.MinGasPrices = minGasPrices
	...
	for i := 0; i < numValidators; i++ {
		...
		// TODO: Rename config file to server.toml as it's not particular to Aneka
		// (REF: https://github.com/cosmos/cosmos-sdk/issues/4125).
		anekaConfigFilePath := filepath.Join(nodeDir, "config/anekad.toml")
		srvconfig.WriteConfigFile(anekaConfigFilePath, anekaConfig)
	}
