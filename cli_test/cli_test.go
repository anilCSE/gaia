...
func TestAnekaCLIKeysAddMultisig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIKeysAddRecover(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIKeysAddRecoverHDPath(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIMinimumFees(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)

	// start anekad server with minimum fees
...
func TestAnekaCLIGasPrices(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIFeesDeduction(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLISend(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIGasAuto(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLICreateValidator(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIQueryRewards(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	genFile := filepath.Join(f.AnekadHome, "config", "genesis.json")
...
func TestAnekaCLIQuerySupply(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLISubmitProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLISubmitParamChangeProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLISubmitCommunityPoolSpendProposal(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIQueryTxPagination(t *testing.T) {
...
func TestAnekaCLIValidateSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLISendGenerateSignAndBroadcast(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIMultisignInsufficientCosigners(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIEncode(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIMultisignSortSignatures(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIMultisign(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
...
func TestAnekaCLIConfig(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
	...
	config, err := ioutil.ReadFile(path.Join(f.AnekacliHome, "config", "config.toml"))
	require.NoError(t, err)
...
func TestAnekadCollectGentxs(t *testing.T) {
	t.Parallel()
...
func TestAnekadAddGenesisAccount(t *testing.T) {
	t.Parallel()
	f := NewFixtures(t)
...
func TestAnekaCLIStatus(t *testing.T) {
	t.Parallel()
	f := InitFixtures(t)
