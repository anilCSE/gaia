...
func InitializeLCD(
	...
	db := dbm.NewMemDB()
	gapp := app.NewAnekaApp(logger, db, nil, true, 0, map[int64]bool{}, "", baseapp.SetPruning(store.PruneNothing))
...
func startTM(
	...
	privVal tmtypes.PrivValidator, app *app.AnekaApp,
) (*nm.Node, error) {
...
// NOTE: If making updates here also update cmd/aneka/cmd/anekacli/main.go
