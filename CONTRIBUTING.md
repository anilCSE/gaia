...
Thank you for considering making contributions to Aneka and related
repositories!
...
1. Either [open](https://github.com/vitwit/aneka/issues/new/choose) or
   [find](https://github.com/vitwit/aneka/issues) an issue you'd like to help with
...
- Looking for a good place to start contributing? How about checking out some
  [good first issues](https://github.com/vitwit/aneka/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
If you open a PR in Aneka, it is mandatory to update the relevant documentation in /docs.

- If your changes relate specifically to the aneka application, please modify the docs/ folder.

## Forking

Please note that Go requires code to live under absolute paths, which complicates forking.
While my fork lives at `https://github.com/rigeyrigerige/aneka`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/aneka`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/vitwit/aneka`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/vitwit/aneka`)
- `git remote rename origin upstream`
- `git remote add origin git@github.com:rigeyrigerige/aneka.git`

Now `origin` refers to my fork and `upstream` refers to the Aneka version.
So I can `git push -u origin master` to update my fork, and make pull requests to Aneka from there.
...
Aneka utilizes [semantic versioning](https://semver.org/).
...
- create a development branch either on github.com/vitwit/aneka, or your fork (using `git remote add origin`)
